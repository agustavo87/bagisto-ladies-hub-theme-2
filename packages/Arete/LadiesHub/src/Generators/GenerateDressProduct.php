...
class GenerateDressProduct extends GenerateEntity 
{
    /**
    ...
    protected $attr_family_code = 'dress';
    ...
    public function create($brand_id = null)
    {
        ...
        $category = $this->categoryRepository->findBySlugOrFail('dresses');
        $data['categories'] = [
            0 => $category->id,
        ];
        ...
        self::$typeLookUp = [
            'text' => function ($attribute, &$data, $faker, $sku, $date, $specialFrom, $specialTo)   {
                ...
                if ($code == 'width'
                    ...
                    $options = ['ring', 'Lace trims', 'Centre front bow', 'High-waist design'];
